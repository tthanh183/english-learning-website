                                    ...
                                    <div class="table-responsive">
                                        <fmt:bundle basename="ResourcesBundle">
                                            <display:table name="items.userImportDTOS" cellspacing="0" cellpadding="0" requestURI="${requestUrl}"
                                                ...
                                                <display:column headerClass="text-left" property="email" titleKey="label.email" />
                                                ...
                                                <display:column headerClass="text-left" property="age" titleKey="label.age" />
                                                <display:column headerClass="text-left" property="gender" titleKey="label.gender" />
                                                <display:column headerClass="text-left" property="address" titleKey="label.address" />
                                                <display:column headerClass="text-left" property="phone" titleKey="label.phone" />
                                                <display:column headerClass="text-left" property="roleName" titleKey="label.role.name"/>
                                                <display:column headerClass="text-left" property="isVip" titleKey="label.isVip" />
                                                <display:column headerClass="text-left" property="isActive" titleKey="label.isActive" />
